...
class CSRFProtect(object):
    """Enable CSRF protection globally for a Flask inventory.

    ::

        inventory = Flask(__name__)
        csrf = CSRFProtect(inventory)
    ...
    def exempt(self, view):
        ...
        ::
            ...
            @inventory.route('/some-view', methods=['POST'])
            @csrf.exempt
            def some_view():
                ...
    ...
    def error_handler(self, view):
        ...
        .. deprecated:: 0.14
            ...
            ``@inventory.errorhandler(CSRFError)`` instead. This will be removed in
            version 1.0.
        ...
        warnings.warn(FlaskWTFDeprecationWarning(
            ...
            'error system with "@inventory.errorhandler(CSRFError)" instead. This '
