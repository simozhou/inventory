...
class LintMiddleware(object):
    ...
    .. code-block:: python
        ...
        inventory = LintMiddleware(inventory)
    """
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn("A WSGI inventory takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI inventory does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
