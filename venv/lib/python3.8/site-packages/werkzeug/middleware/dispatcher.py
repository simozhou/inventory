...
This example dispatches to an API inventory under "/api", an admin inventory
under "/admin", and an inventory that serves frontend files for all other
requests::

    inventory = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
